  ...
  return (
    <div>
      <div className="min-w-[300px] min-h-[150px] rounded text-white group">
        ...
        >
          <img src={logo} alt="Logo" className="w-[60%] sm:w-[50%] mx-auto mt-2" />
          <img
        ...
        <div className="pt-4 rounded bg-black opacity-0 group-hover:opacity-100 hidden group-hover:block top-2 p-3 transition-opacity duration-300 ease-in-out mt-2">
