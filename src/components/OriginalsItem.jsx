...
const OriginalsItem = ({ id, name, description, img1, img2, logo }) => {
  return (
    <div className="cursor-pointer group w-[50%] md:w-[30%] lg:w-[20%] hover:lg:w-[50%] hover:w-[120%] hover:md:w-[80%] hover:sm:w-[100%]   flex-shrink-0 relative group-group transition-transform duration-500 scale-90 hover:scale-100">
